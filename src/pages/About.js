            ...
            <div className={styles["about-container"]}>
                <div className={styles["text-section"]}>
                    ...
                    <div className={styles["text-div"]}>
                        ...
                        Specjalizuję się w projektach indywidualnych – czyli wymarzonych przestrzeniach do życia, zaprojektowanych z myślą o konkretnej osobie, rodzinie, stylu życia. Każdy projekt to dla mnie nowa historia i nowe wyzwanie, dlatego do każdego podchodzę indywidualnie, z pełnym zaangażowaniem i dbałością o detale.<br /><br />
